...
def initialize_elo_ratings(teams:list, initial_elo=1500):
...
def elo_ratings_over_time(matches, elo_ratings, k_value=32, k_adjustment_game_num=3, weight=0.5):
    ...
    for _, row in matches.iterrows():
        ...
        elo_ratings_over_time.append((team1, team2, new_rating1, new_rating2))
        
    # Convert to DataFrame for easier analysis and visualization
    elo_df = pd.DataFrame(elo_ratings_over_time, columns=['team1', 'team2', 'elo1', 'elo2'])
